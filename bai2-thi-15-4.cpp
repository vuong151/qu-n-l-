...
int main()
{
    ...
    if (diemMax == diemTruongA)
    {
        ...
        if (diemMax == diemTruongB){
        	cout << "Cung voi truong B" << endl;
        }
        if (diemMax == diemTruongC){
        		cout << "Cung voi ca truong C" << endl;
        		}
    }
    ...
    else if (diemMax == diemTruongC)
    {
        ...
        if (diemMax == diemTruongA){
        		cout << "Cung voi ca truong A" << endl;
        		}
    }
